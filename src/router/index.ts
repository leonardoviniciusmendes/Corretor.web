...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/leads', name: 'leads-list', component: LeadsListView, meta: { title: 'Leads' } },
    { path: '/leads/novo', name: 'leads-new', component: LeadFormView, meta: { title: 'Novo lead' } },
    { path: '/leads/:id', name: 'leads-detail', component: LeadDetailView, props: (route: RouteLocationNormalizedLoaded) => ({ id: String(route.params.id) }), meta: { title: 'Detalhe do lead' } },
    { path: '/leads/:id/editar', name: 'leads-edit', component: LeadFormView, props: (route: RouteLocationNormalizedLoaded) => ({ id: String(route.params.id) }), meta: { title: 'Editar lead' } },
